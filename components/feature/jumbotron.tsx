  ...
  return (
    ...
    >
      <Image
        ...
        priority
      />
      <p className="text-[#761dc2] tracking-widest text-xl my-4">
        FULLSTACK DEVELOPER
      </p>
      <p className="text-[1rem] mt-6 text-[#aeacb9]">
        I build modern and scalable web applications <br/> with clean and sharp focus.
      </p>
      {/* Sharinggan Button */}
      <SharinganButton />
      {/* List Icon */}
      <NavigationMenu className="mt-16">
        ...
        <NavigationMenuList className="flex items-center justify-between gap-4">
          <NavigationMenuItem className="flex items-center justify-center gap-8">
